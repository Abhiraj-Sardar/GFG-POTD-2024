...
# find its peak element. An element is considered to be 
# peak if it's value is greater than or equal to the values
# of its adjacent elements (if they exist).

# Note: The output will be 1 if the index returned by your 
...
# Since arr[2] = 3 is greater than its adjacent elements, and there
# is no element after it, we can consider it as a peak element. No 
# other index satisfies the same property.
...
# 1
# Explanation: 
# In this case there are 5 peak elements with indices as {0,1,3,5,6}. 
