...
# You are given an array arr[] of length n, you have 
# to re-construct the same array arr[] in-place. 
...
# with the values obtained by performing the bitwise OR operation 
# on consecutive elements.
